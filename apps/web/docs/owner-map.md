...
| `/dashboard/usajobs` | `app/dashboard/usajobs/page.tsx` | Guided USAJOBS Mode |
...
| `store/guidedUsaJobsStore.ts` | `pathos-guided-usajobs-goals-v1` | Guided USAJOBS goals, interaction state |
...
| `GUIDED_USAJOBS_GOALS_STORAGE_KEY` | `pathos-guided-usajobs-goals-v1` | guidedUsaJobsStore |
