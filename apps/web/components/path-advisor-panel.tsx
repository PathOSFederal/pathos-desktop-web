...
export function PathAdvisorPanel(props: PathAdvisorPanelProps) {
  ...
  useEffect(function () {
    console.log('[PathAdvisorPanel] Render - messages count:', messages.length, 'message IDs:', messages.map(function (m) { return m.id; }));
    if (messages.length > 0) {
      console.log('[PathAdvisorPanel] Last message preview:', messages[messages.length - 1].content.substring(0, 100));
    }
  }, [messages.length]);
