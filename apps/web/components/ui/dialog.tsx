    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'inset-0 rounded-none p-4',
          // Base classes: Default max-w-lg for small screens
          // Day 39: className comes LAST to ensure caller className overrides base classes
          // This allows sm:max-w-6xl in caller to override sm:max-w-lg from base classes
          'sm:inset-auto sm:top-[50%] sm:left-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:w-full sm:max-w-lg sm:rounded-lg sm:p-6',
          className,
        )}
        {...props}
      >
